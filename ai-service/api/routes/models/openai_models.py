...
class OpenAICodeAgentRequest(BaseModel):
    message: str = Field(..., description="human message to code agent")

class OpenAICodeAgentResponse(BaseModel):
    ...
    files:Dict[str, str] = Field(..., description="list of files updated and their respective paths")
