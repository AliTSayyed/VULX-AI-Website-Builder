...
@router.post("/code/{id}")
async def code_agent_request(id:id, message:str, openai_code_agent: openai_code_agent_service_dependency):
    try:
        openai_code_agent.process_code_agent_request(sandbox_id=id, user_message=message)
        pass
