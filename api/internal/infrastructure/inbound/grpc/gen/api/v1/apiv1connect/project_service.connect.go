...
const (
	...
	// ListProjects RPC.
	ProjectServiceListProjectsProcedure = "/api.v1.ProjectService/ListProjects"
	// ProjectServiceGetProjectProcedure is the fully-qualified name of the ProjectService's GetProject
	// RPC.
	ProjectServiceGetProjectProcedure = "/api.v1.ProjectService/GetProject"
	// ProjectServiceCreateProjectProcedure is the fully-qualified name of the ProjectService's
	// CreateProject RPC.
	ProjectServiceCreateProjectProcedure = "/api.v1.ProjectService/CreateProject"
)
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_api_v1_project_service_proto.Services().ByName("ProjectService").Methods()
...
// ListProjects calls api.v1.ProjectService.ListProjects.
...
// GetProject calls api.v1.ProjectService.GetProject.
...
// CreateProject calls api.v1.ProjectService.CreateProject.
...
func (UnimplementedProjectServiceHandler) ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.ProjectService.ListProjects is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) GetProject(context.Context, *connect.Request[v1.GetProjectRequest]) (*connect.Response[v1.GetProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.ProjectService.GetProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) CreateProject(context.Context, *connect.Request[v1.CreateProjectRequest]) (*connect.Response[v1.CreateProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.ProjectService.CreateProject is not implemented"))
}
